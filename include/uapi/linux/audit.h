...
#define AUDIT_KL_FIRST_KEY	1020    /* Receive the first key of integrity key set */ 
...
#define AUDIT_STATUS_KENNY_LOGGINGS		0x0100
...
struct audit_status {
	...
	__u32           backlog_wait_time_actual;/* time spent waiting while
						  ...
						  */
	__u32		kenny_loggings;	/* Integrity Proofs activated */
};
